...
class CourseUniversities extends React.Component {
      constructor(props) {
            super(props)
            this.state = {
                              ...
                              <div className="row">
                                    <div className="col-sm-12">
                                          <div className="top-contentt">
                                                <h2 className="title"><span> More »</span></h2>
                                                <span>Discover the courses and universities most loved by students</span>
                                          </div>
                                    </div>
                                    <div className="col-sm-12">
